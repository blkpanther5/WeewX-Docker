...
RUN cd /tmp && wget http://weewx.com/downloads/released_versions/weewx-3.9.2.tar.gz && tar xvfz weewx-3.9.2.tar.gz && cd weewx-3.9.2 && ./setup.py build && ./setup.py install --no-prompt
